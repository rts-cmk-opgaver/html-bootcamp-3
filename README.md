...
<!-- 'Alt'-attributter gør det muligt for en skærmlæser at læse oplysninger om billeder på siden. Det er til gavn for en person med synshandicap, eller som på anden måde ikke er i stand til at se billederne på siden. 'Alt' tekst vil blive vist i stedet for et billede, hvis en billedfil ikke kan indlæses. -->
